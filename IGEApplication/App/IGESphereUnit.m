...
#import "../Library/IGELineStream.h"
...
- (id)init
{
	...
	IGEVector3* positionData = malloc((_horizontalDiv+1) * (_verticalDiv+1) * sizeof(IGEVector3));
	...
	_vertexData = malloc(_horizontalDiv * _verticalDiv * 3*2 * sizeof(struct VertexInfo));
